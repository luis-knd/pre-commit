...
def setup_logging():
    ...
    :return: None
    """
    logs_dir = f'/tmp/prSuggestions/src/data/logs'
...
def parse_command_line_arguments():
    ...
    :return: Tuple containing the parsed Jira key, input file and project_path.
    :rtype: tuple[str, str]
    """
    ...
    return args.jira_key, args.input_file, args.project_path
