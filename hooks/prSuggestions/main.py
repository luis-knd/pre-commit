...
if __name__ == "__main__":
    ...
    try:
        jira_key, input_file, project_path = parse_command_line_arguments()
    ...
    # print(f"salgo aca por ahora: {input_file} {jira_key}")
    # sys.exit(0)
    ...
    relative_file_path = f"/tmp/prSuggestions/src/data/cr_suggestions/{file_name}"
